Vue.component('login_form', {
    ...
    <div class="login">
        ...
        <form class="form-group fom" id="form2" method="POST" action="/login">
                
            <input class="textbox" type="text" name="email" v-model="email" placeholder="Email" required/>
        
            <input class="textbox" type="password" name="password" v-model="password" placeholder="Password" required/>
