        ...
        <div class="col">
          ...
          <div class="main" style="overflow-x: hidden;">
              <div class="container text-center">
                  ...
                  <h3 style="color: white;text-align: left;padding-left: 20px;padding-top: 20px;padding-bottom: 20px;">Songs in <strong>{{title}}</strong> playlist</h3>
...
,
  methods:{
    del: async function(sid) {
      confirm('Are you sure you want to remove song from album?');
    var myHeaders = new Headers();
    myHeaders.append("Authorization", "Bearer "+localStorage.getItem('Token'));

    var formdata = new FormData();
    formdata.append("aid", localStorage.getItem('aid'));
    formdata.append("type", "songalbumdelete");
    ...
    var requestOptions = {
      ...
      fetch("http://127.0.0.1:8000/api/song", requestOptions)
        ...
        console.log('removed song from album');
...
,
  mounted: async function() {
    ...
    songs = await fetch("http://127.0.0.1:8000/api/song?type=album&aid="+localStorage.getItem('aid'), requestOptions)
    .then(response => response.text());
